...
for (var x = 0; x < 3; x++) {
   ...
   cubes.position.set(x*3-3,y*3,z*3+3);
       ...
       this.group1.position.y = -4.5;
       this.group2.position.y = -4.5;
       this.group1.position.z = -4.5;
       this.group2.position.z = -4.5;
       this.group1.position.x = -4.5;
       this.group2.position.x = -4.5;
   ...
   public render() {
    ...
    this.angle += 0.001;
    this.camera.lookAt(new THREE.Vector3(0, 0, 0));
       this.group1.rotation.x += 0.02;
       this.group1.rotation.y += 0.02;
       this.group2.rotation.x += 0.02;
       this.group2.rotation.y += 0.02;
       this.group2.rotation.z += 0.04;
