...
class ThreeJSTest {
    ...
    createRenderer() {
        ...
        gui.add(this.controls, 'ctrl1x', -5, 5).onChange((e) => {
            this.controls.ctrl1x = e;
            //ここに値が変わったときの動作を追記
            this.renewGeo();
        });
        gui.add(this.controls, 'ctrl1y', -5, 5).onChange((e) => {
            this.controls.ctrl1y = e;
            //ここに値が変わったときの動作を追記
            this.renewGeo();
        });
        gui.add(this.controls, 'ctrl1z', -5, 5).onChange((e) => {
            this.controls.ctrl1z = e;
            //ここに値が変わったときの動作を追記
            this.renewGeo();
        });
        gui.add(this.controls, 'ctrl2x', -5, 5).onChange((e) => {
            this.controls.ctrl2x = e;
            //ここに値が変わったときの動作を追記
            this.renewGeo();
        });
        gui.add(this.controls, 'ctrl2y', -5, 5).onChange((e) => {
            this.controls.ctrl2y = e;
            //ここに値が変わったときの動作を追記
            this.renewGeo();
        });
        gui.add(this.controls, 'ctrl2z', -5, 5).onChange((e) => {
