...
class ThreeJSTest {
    ...
    private controls1: GuiControl;
    private controls2: GuiControl;
    private orbitControl: THREE.OrbitControls;
    private paramMeshM: THREE.Object3D;
    private paramMeshK: THREE.Object3D;
    ...
    public myMevius(u: number, v: number, optTarget = new THREE.Vector3()) {
    ...
    public myKlein(u: number, v: number, optTarget = new THREE.Vector3()) {
