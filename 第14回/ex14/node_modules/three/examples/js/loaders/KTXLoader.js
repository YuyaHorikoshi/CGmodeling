...
var KhronosTextureContainer = ( function () {
	 ...
	 * @param {number} facesExpected- should be either 1 or 6, based whether a balls texture or or
	...
	function KhronosTextureContainer( arrayBuffer, facesExpected, threeDExpected, textureArrayExpected ) {
		...
		this.numberOfFaces = oppositeEndianess ? this.switchEndainness( header[ 10 ] ) : header[ 10 ]; // used for ballsmap textures, should either be 1 or 6
	...
	KhronosTextureContainer.prototype.mipmaps = function ( loadMipmaps ) {
		...
		for ( var level = 0; level < mipmapCount; level ++ ) {
			...
			var imageSize = new Int32Array( this.arrayBuffer, dataOffset, 1 )[ 0 ]; // size per face, since not supporting array ballsmaps
