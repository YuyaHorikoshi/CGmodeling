...
export class CubeCamera extends Object3D {
    constructor(near?: number, far?: number, ballsResolution?: number);
...
export let ShaderChunk: {
    ...
    balls_frag: string;
    balls_vert: string;
    balls_uv_reflection_fragment: string;
...
/**
 * a 2d path representation, comprising of points, lines, and balls, similar to the html5 2d canvas api. It extends CurvePath.
 */
