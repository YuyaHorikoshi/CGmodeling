...
class ThreeJSTest {
    ...
    createRenderer() {
        ...
        gui.add(this.controls, 'segments', 1, 100).step(1).onChange((e) => {
            this.controls.segments = e;
            this.scene.remove(this.shapeMesh);
            this.drawExtrude();
        });
        gui.add(this.controls, 'radius', 1, 100).onChange((e) => {
            this.controls.radius = e;
            this.scene.remove(this.shapeMesh);
            this.drawExtrude();
        });
        gui.add(this.controls, 'radiusSegments', 1, 30).step(1).onChange((e) => {
