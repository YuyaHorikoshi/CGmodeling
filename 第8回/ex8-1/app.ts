...
class ThreeJSTest {
    ...
    private createRenderer() {
        ...
        gui.add(this.controls, 'amount', 0, 10).onChange((e: number) => {
            this.controls.amount = e;
            this.scene.remove(this.shapeMesh);
            this.drawExtrude();
        })
        gui.add(this.controls, 'bevelThickness', 0, 10).onChange((e: number) => {
            this.controls.bevelThickness = e;
            this.scene.remove(this.shapeMesh);
            this.drawExtrude();
        })
        gui.add(this.controls, 'bevelSize', 0, 10).onChange((e: number) => {
            this.controls.bevelSize = e;
            this.scene.remove(this.shapeMesh);
            this.drawExtrude();
        })
        gui.add(this.controls, 'bevelSegment', 0, 10).onChange((e: number) => {
