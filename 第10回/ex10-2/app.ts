...
class ThreeJSTest {
    ...
    private mergeMesh: THREE.Mesh;
    private groupMesh: THREE.Mesh;
    ...
    private createRenderer() {
        ...
        gui.add(this.controls, 'particleNum', 0, 50000).onChange((e: number) => {
    ...
    public group0() {
        //ジオメトリの作成
        var geom:THREE.Geometry = new THREE.BoxGeometry(1, 1, 1);
        //マテリアルの作成
    ...
    public merge0() {
        ...
        for (var i = 0; i < this.controls.particleNum; i++) {
            ...
            geometry.merge(<THREE.Geometry>mesh.geometry, mesh.matrix);
        }
        //シーンへの追加
